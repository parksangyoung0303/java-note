...
public class A_Variable {
	...
	public static void main(String[] args) {
		...
		// 변수는 선언 후 반드시 초기화 한 다음 사용 할 수 있다.
		// int number3 = 11;
		...
		// 변수 명명 규칙
		// 1. 문법적 - 중복된 변수명을 사용할 수 없음
		int number4;
		// int number4;
		// 변수의 데이터 타입이 다르더라도 같은 변수명을 사용 할 수 없음
		// double number4;
		// 대소문자를 구분해서 사용 가
		int Number4;
		...
		// int number+;
		// int number_$; << _ 는 사용가능 $는 변수명을 아직 미지정하고 추후 재지정할때 사용
		
		// 3. 변수명은 숫자로 시작할 수 없음
		// int 1number;
		
		// 4. 키워드로만 구성되어있는 단어는 사용할 수 없음
		// int public; ex) class, public, void ...
		
		// 비문법상 규칙 (암묵적 룰)
		// 1. 띄워쓰기 규칙
		// String homeaddress;
		// - Camel Case : 띄워쓰기를 표현할 때 띄워쓰기 제거하고 바로 뒤 문자를 대문자로 표현
		String homeAddress;
		...
		// UpperCamelCase : 첫글자를 대문자로 시작 - 클래스, 인터페이스   * 프로그래밍언어 사용 ex) java
		// lowerCamelCase : 첫글자를 소문자로 시작 - 변수, 함수, 메서드	* 프로그래밍언어 사용 ex) java
		// UPPER_SNAKE_CASE : 모든 글자를 대문자로 작성 - 상수형 변수
		// lower_snake_case : 모든 글자를 소문자로 작성 - 변수, 함수, 메서드	* 스크립트 사용 ex) javascript, React
		
		// 2.약어 사용 금지
		// 단축어를 사용하지 않도록 약속
		// 자신만 알고 있는 약어를 사용하면 다른 개발자가 이해하기 어려움
		// 독일식표기법 사용하여 변수명 작성을 권장
		int subractYesterdaysDateTodaysResults = 0;
		...
		// 리터럴으로만 표현한다면 해당하는 리터럴이 무엇인지 이해하기 어려움
		...
		// int age = 31; 이라는 구문에서 '31'가 리털럴에 해당
		// 31 = 10; 될수가 없음 
	}
