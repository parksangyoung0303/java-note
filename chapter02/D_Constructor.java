...
// 클래스와 같은 이름을 가짐, 반환 타입은 존재 하지 않는다.
...
class Human1 {
	...
	// 만약 다른 생성자(매개변수가 존재하는 생성자)만 존재한다면 기본 생성자는 자동으로 생성되지 않음
	Human1() {
		...
		// 2. 인스턴스를 생성과 동시에 인스턴스 변수를 초기화하고 싶을 때, 의존성을 내부에서 주입하는 행위
		name = "홍길동";
		age = 20;
		gender = "남";
		// address = "부산";
...
public class D_Constructor {
	...
	public static void main(String[] args) {
		...
		// 기본 생성자 - 만약 클래스에 생성자를 정의하지 않으면 컴파일러가 알아서 자동으로 기본 생성자를 제공함
		Human1 human1 = new Human1(); // 인스턴스 생성 행위
