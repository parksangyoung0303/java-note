...
public class B_Package1 {
	...
	public static void main(String[] args) {
		...
		// wrapper 클래스는 null 을 가질 수 있기 떄문에 기본형 데이터 타입에 참조형 데이터 타입을 할당할 땐 주의 해야함
