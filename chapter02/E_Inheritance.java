...
// 코드의 중복을 제거하여 코드 재사용성, 유지보수성, 확장성을 높을 수 있음
// extends 키워드를 사용
...
// 다이아몬드 문제 : 다중 상속으로 인해 동일한 이름의 메서드를 상속받은 상태에서 어떤 메서드를 선택해야할지 모호해지는 문제
// 인터페이스 사용하여 다중 상속 효과를 볼수 있음, 중첩 상속을 사용하여 다중 상속 효과를 볼수 있음
...
//	}
	...
	// Human 클래스에서 상속 받은 sleep 메서드를 오버로딩한 것 - 다형성
	void sleep(int time) {
...
class SalesMan extends Human {
	...
	void sleep() {
		...
		// 오버라이딩을 통해서 코드의 재사용성을 증가 시킬수 있음
		super.sleep();
		// System.out.println(name + "이 잠을 잔다.");
	}
	// void eat() {}
